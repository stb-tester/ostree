 ...
 * @OSTREE_REPO_COMMIT_FILTER_WHITEOUT: Delete the object from the previous layer
 * @OSTREE_REPO_COMMIT_FILTER_OPAQUE: Instead of merging contents of direcotyr
 */
typedef enum {
  OSTREE_REPO_COMMIT_FILTER_ALLOW,
  OSTREE_REPO_COMMIT_FILTER_SKIP,
  OSTREE_REPO_COMMIT_FILTER_WHITEOUT,
  OSTREE_REPO_COMMIT_FILTER_OPAQUE
} OstreeRepoCommitFilterResult;
 ...
 * @OSTREE_REPO_COMMIT_MODIFIER_FLAGS_OVERLAYFS: Interpret overlayfs whiteouts and opaque directory xattrs; Since: 2018.7
 */
typedef enum {
  ...
  OSTREE_REPO_COMMIT_MODIFIER_FLAGS_OVERLAYFS = (1 << 6),
} OstreeRepoCommitModifierFlags;
